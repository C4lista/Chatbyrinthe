Chatbyrinthe est un petit prototype de jeu de labyrinthe développé en GDScript avec Godot 4.2.

La release contient Chatbyrinthe.exe et Chatbyrinthe.pck (le fichier de ressources du jeu)
Les deux fichiers doivent être placés dans le même dossier pour que le jeu fonctionne.
